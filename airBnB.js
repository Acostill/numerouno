...
function setOccupancy(arr) {
    var max = arr[2]
    var thisRoom = rooms[arr[1] - 1]

    thisRoom.maxOccupants = max
    console.log('Max occupants in ' + thisRoom.location + ' set to ' + max)
}

function searchAmenity(arr) {
    var amenity = arr[1]
    console.log(
        padLeft('ID', 2),
        '...',
...
rl.on('line', function(input) {
    ...
    } else if (inputArr[0] === 'set_max_occupants') {
        setOccupancy(inputArr)
    } else if (inputArr[0] === 'has_amenity') {
        searchAmenity(inputArr)
    } else {
